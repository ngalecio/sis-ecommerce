...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/productos/update/' . $producto->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nombre" id="nombre"
                                                value="{{ old('nombre', $producto->nombre) }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="codigo" id="codigo"
                                                value="{{ old('codigo', $producto->codigo) }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="prescripcion" id="prescripcion"
                                                value="{{ old('prescripcion', $producto->prescripcion) }}"
                                                class="form-control" placeholder="Ingrese la prescripcion del producto">
                                        </div>
                                        @error('prescripcion')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="name">Stock Fracción(*)</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text"><i class="bi bi-boxes"></i></span>
                                                                            <input type="text" name="stock_fraccion" id="stock_fraccion" value="{{ old('stock_fraccion', $producto->stock_fraccion) }}"
                                                                                class="form-control text-end" step="1" min="0" placeholder="0" required>
                                                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="tipo_producto" id="tipo_producto" class="form-control"
                                                ...
                                                <option value="B" {{ old('tipo_producto', $producto->tipo_producto) ==
                                                    'B' ? 'selected' : '' }}>BIEN</option>
                                                <option value="S" {{ old('tipo_producto', $producto->tipo_producto) ==
                                                    'S' ? 'selected' : '' }}>SERVICIO</option>

                                                <option value="I" {{ old('tipo_producto', $producto->tipo_producto) ==
                                                    'I' ? 'selected' : '' }}>INSUMO</option>
                                                <option value="O" {{ old('tipo_producto', $producto->tipo_producto) ==
                                                    'O' ? 'selected' : '' }}>OBSEQUIO</option>
                                            </select>
                                        </div>
                                        @error('tipo_producto')
                                        <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="aplica_iva" id="aplica_iva" class="form-control" required>
                                                <option value="">-- Seleccione --</option>
                                                <option value="0" {{ old('aplica_iva', $producto->aplica_iva) == '0' ?
                                                    'selected' : '' }}>0% IVA</option>
                                                <option value="2" {{ old('aplica_iva', $producto->aplica_iva) == '2' ?
                                                    'selected' : '' }}>Grava IVA</option>
                                            </select>
                                        </div>
                                        @error('aplica_iva')
                                        <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            onchange="handleUnidadMedidaChange()">
                                                ...
                                                <option value="{{ $unidad->codigo_catalogo_detalle }}" {{
                                                    old('unidad_medida', $producto->unidad_medida)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="cantidad_por_unidad" id="cantidad_por_unidad"
                                                value="{{ old('cantidad_por_unidad', $producto->cantidad_por_unidad) }}"
                                                class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="estado" id="estado" class="form-control" required>
                                                <option value="">-- Seleccione --</option>
                                                <option value="A" {{ old('estado', $producto->estado) == 'A' ?
                                                    'selected' : '' }}>ACTIVO</option>
                                                <option value="I" {{ old('estado', $producto->estado) == 'I' ?
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="imprime_receta" id="imprime_receta" class="form-control"
                                                required>
                                                <option value="">-- Seleccione --</option>
                                                <option value="N" {{ old('imprime_receta', $producto->imprime_receta) ==
                                                    'N' ? 'selected' : '' }}>NO</option>
                                                <option value="S" {{ old('imprime_receta', $producto->imprime_receta) ==
                                                    'S' ? 'selected' : '' }}>SI</option>
                                            </select>
                                        </div>
